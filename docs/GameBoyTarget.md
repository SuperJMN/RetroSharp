...
- Fixed-size local arrays of plain structs whose fields are byte-backed, with constant or byte-backed runtime field reads/writes such as `actors[i].x`
