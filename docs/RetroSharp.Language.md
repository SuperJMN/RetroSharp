...
- Extend array support from local byte-backed elements and byte-backed struct elements to pointer-backed arrays, struct-array initializers, and wider element layouts.
...
- Add unit tests covering pointer field access, address-of, struct-array initializers, and backend-specific word-sized field layout.
