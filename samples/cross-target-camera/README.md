...
- This portable sample uses only horizontal `Camera.SetPosition(x, 0)`. NES vertical and diagonal free-scroll capability is covered by `../source-free-scroll/freescroll.rs` and `../tiled-free-scroll/free-scroll.rs`, not by this cross-target sample.
