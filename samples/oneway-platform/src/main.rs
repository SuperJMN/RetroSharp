...
void ResolveLanding(PlayerState player, Pixel screenX, Pixel previousFootY, Pixel footY)
{
    ...
    {
        i16 top = Camera.AabbHitTop(screenX, footY - CollisionProbe.LandingSearchTopOffset, Sprite.Width(player_sprite), CollisionProbe.LandingSearchHeight, CollisionFlag.Landable);
...
void Main()
{
    ...
    World.Load("assets/oneway-platform.tmj");
