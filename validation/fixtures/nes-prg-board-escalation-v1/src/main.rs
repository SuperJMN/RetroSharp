...
// The fold stream below is generated bulk: 400 distinct branch folds over a running
...
// Final state after the stream: mixer == 23424, counter.value == 8.
...
void Main()
{
    ...
    // The heavy stream runs before rendering is enabled, so board selection is the only thing
    // this canary stresses; the steady frame loop below owns cadence and video safety.
    Counter counter;
    counter.value = 0;
    u16 mixer;
    mixer = 1;
    ...
    if (mixer > 10620) { mixer = mixer - 3760; counter.value += 1; } else { mixer = mixer + 7840; }
    if (mixer > 10657) { mixer = mixer - 3776; counter.value += 1; } else { mixer = mixer + 7869; }
    if (mixer > 10694) { mixer = mixer - 3792; counter.value += 1; } else { mixer = mixer + 7898; }
    if (mixer > 10731) { mixer = mixer - 3808; counter.value += 1; } else { mixer = mixer + 7927; }
    if (mixer > 10768) { mixer = mixer - 3824; counter.value += 1; } else { mixer = mixer + 7956; }
    if (mixer > 10805) { mixer = mixer - 3840; counter.value += 1; } else { mixer = mixer + 7985; }
    if (mixer > 10842) { mixer = mixer - 3856; counter.value += 1; } else { mixer = mixer + 8014; }
    if (mixer > 10879) { mixer = mixer - 3872; counter.value += 1; } else { mixer = mixer + 8043; }
    if (mixer > 10916) { mixer = mixer - 3888; counter.value += 1; } else { mixer = mixer + 8072; }
    if (mixer > 10953) { mixer = mixer - 3904; counter.value += 1; } else { mixer = mixer + 8101; }
    if (mixer > 10990) { mixer = mixer - 3920; counter.value += 1; } else { mixer = mixer + 8130; }
    if (mixer > 11027) { mixer = mixer - 3936; counter.value += 1; } else { mixer = mixer + 8159; }
    if (mixer > 11064) { mixer = mixer - 3952; counter.value += 1; } else { mixer = mixer + 8188; }
    if (mixer > 11101) { mixer = mixer - 3968; counter.value += 1; } else { mixer = mixer + 8217; }
    if (mixer > 11138) { mixer = mixer - 3984; counter.value += 1; } else { mixer = mixer + 8246; }
    if (mixer > 11175) { mixer = mixer - 4000; counter.value += 1; } else { mixer = mixer + 8275; }
    if (mixer > 11212) { mixer = mixer - 4016; counter.value += 1; } else { mixer = mixer + 8304; }
    if (mixer > 11249) { mixer = mixer - 4032; counter.value += 1; } else { mixer = mixer + 8333; }
    if (mixer > 11286) { mixer = mixer - 4048; counter.value += 1; } else { mixer = mixer + 8362; }
    if (mixer > 11323) { mixer = mixer - 4064; counter.value += 1; } else { mixer = mixer + 8391; }
    if (mixer > 11360) { mixer = mixer - 4080; counter.value += 1; } else { mixer = mixer + 8420; }
    if (mixer > 11397) { mixer = mixer - 4096; counter.value += 1; } else { mixer = mixer + 8449; }
    if (mixer > 11434) { mixer = mixer - 4112; counter.value += 1; } else { mixer = mixer + 8478; }
    if (mixer > 11471) { mixer = mixer - 4128; counter.value += 1; } else { mixer = mixer + 8507; }
    if (mixer > 11508) { mixer = mixer - 4144; counter.value += 1; } else { mixer = mixer + 8536; }
    if (mixer > 11545) { mixer = mixer - 4160; counter.value += 1; } else { mixer = mixer + 8565; }
    if (mixer > 11582) { mixer = mixer - 4176; counter.value += 1; } else { mixer = mixer + 8594; }
    if (mixer > 11619) { mixer = mixer - 4192; counter.value += 1; } else { mixer = mixer + 8623; }
    if (mixer > 11656) { mixer = mixer - 4208; counter.value += 1; } else { mixer = mixer + 8652; }
    if (mixer > 11693) { mixer = mixer - 4224; counter.value += 1; } else { mixer = mixer + 8681; }
    if (mixer > 11730) { mixer = mixer - 4240; counter.value += 1; } else { mixer = mixer + 8710; }
    if (mixer > 11767) { mixer = mixer - 4256; counter.value += 1; } else { mixer = mixer + 8739; }
    if (mixer > 11804) { mixer = mixer - 4272; counter.value += 1; } else { mixer = mixer + 8768; }
    if (mixer > 11841) { mixer = mixer - 4288; counter.value += 1; } else { mixer = mixer + 8797; }
    if (mixer > 11878) { mixer = mixer - 4304; counter.value += 1; } else { mixer = mixer + 8826; }
    if (mixer > 11915) { mixer = mixer - 4320; counter.value += 1; } else { mixer = mixer + 8855; }
    if (mixer > 11952) { mixer = mixer - 4336; counter.value += 1; } else { mixer = mixer + 8884; }
    if (mixer > 11989) { mixer = mixer - 4352; counter.value += 1; } else { mixer = mixer + 8913; }
    if (mixer > 12026) { mixer = mixer - 4368; counter.value += 1; } else { mixer = mixer + 8942; }
    if (mixer > 12063) { mixer = mixer - 4384; counter.value += 1; } else { mixer = mixer + 8971; }
    if (mixer > 12100) { mixer = mixer - 4400; counter.value += 1; } else { mixer = mixer + 9000; }
    if (mixer > 12137) { mixer = mixer - 4416; counter.value += 1; } else { mixer = mixer + 9029; }
    if (mixer > 12174) { mixer = mixer - 4432; counter.value += 1; } else { mixer = mixer + 9058; }
    if (mixer > 12211) { mixer = mixer - 4448; counter.value += 1; } else { mixer = mixer + 9087; }
    if (mixer > 12248) { mixer = mixer - 4464; counter.value += 1; } else { mixer = mixer + 9116; }
    if (mixer > 12285) { mixer = mixer - 4480; counter.value += 1; } else { mixer = mixer + 9145; }
    if (mixer > 12322) { mixer = mixer - 4496; counter.value += 1; } else { mixer = mixer + 9174; }
    if (mixer > 12359) { mixer = mixer - 4512; counter.value += 1; } else { mixer = mixer + 9203; }
    if (mixer > 12396) { mixer = mixer - 4528; counter.value += 1; } else { mixer = mixer + 9232; }
    if (mixer > 12433) { mixer = mixer - 4544; counter.value += 1; } else { mixer = mixer + 9261; }
    if (mixer > 12470) { mixer = mixer - 4560; counter.value += 1; } else { mixer = mixer + 9290; }
    if (mixer > 12507) { mixer = mixer - 4576; counter.value += 1; } else { mixer = mixer + 9319; }
    if (mixer > 12544) { mixer = mixer - 4592; counter.value += 1; } else { mixer = mixer + 9348; }
    if (mixer > 12581) { mixer = mixer - 4608; counter.value += 1; } else { mixer = mixer + 9377; }
    if (mixer > 12618) { mixer = mixer - 4624; counter.value += 1; } else { mixer = mixer + 9406; }
    if (mixer > 12655) { mixer = mixer - 4640; counter.value += 1; } else { mixer = mixer + 9435; }
    if (mixer > 12692) { mixer = mixer - 4656; counter.value += 1; } else { mixer = mixer + 9464; }
    if (mixer > 12729) { mixer = mixer - 4672; counter.value += 1; } else { mixer = mixer + 9493; }
    if (mixer > 12766) { mixer = mixer - 4688; counter.value += 1; } else { mixer = mixer + 9522; }
    if (mixer > 12803) { mixer = mixer - 4704; counter.value += 1; } else { mixer = mixer + 9551; }
    if (mixer > 12840) { mixer = mixer - 4720; counter.value += 1; } else { mixer = mixer + 9580; }
    if (mixer > 12877) { mixer = mixer - 4736; counter.value += 1; } else { mixer = mixer + 9609; }
    if (mixer > 12914) { mixer = mixer - 4752; counter.value += 1; } else { mixer = mixer + 9638; }
    if (mixer > 12951) { mixer = mixer - 4768; counter.value += 1; } else { mixer = mixer + 9667; }
    if (mixer > 12988) { mixer = mixer - 4784; counter.value += 1; } else { mixer = mixer + 9696; }
    if (mixer > 13025) { mixer = mixer - 4800; counter.value += 1; } else { mixer = mixer + 9725; }
    if (mixer > 13062) { mixer = mixer - 4816; counter.value += 1; } else { mixer = mixer + 9754; }
    if (mixer > 13099) { mixer = mixer - 4832; counter.value += 1; } else { mixer = mixer + 9783; }
    if (mixer > 13136) { mixer = mixer - 4848; counter.value += 1; } else { mixer = mixer + 9812; }
    if (mixer > 13173) { mixer = mixer - 4864; counter.value += 1; } else { mixer = mixer + 9841; }
    if (mixer > 13210) { mixer = mixer - 4880; counter.value += 1; } else { mixer = mixer + 9870; }
    if (mixer > 13247) { mixer = mixer - 4896; counter.value += 1; } else { mixer = mixer + 9899; }
    if (mixer > 13284) { mixer = mixer - 4912; counter.value += 1; } else { mixer = mixer + 9928; }
    if (mixer > 13321) { mixer = mixer - 4928; counter.value += 1; } else { mixer = mixer + 9957; }
    if (mixer > 13358) { mixer = mixer - 4944; counter.value += 1; } else { mixer = mixer + 9986; }
    if (mixer > 13395) { mixer = mixer - 4960; counter.value += 1; } else { mixer = mixer + 10015; }
    if (mixer > 13432) { mixer = mixer - 4976; counter.value += 1; } else { mixer = mixer + 10044; }
    if (mixer > 13469) { mixer = mixer - 4992; counter.value += 1; } else { mixer = mixer + 10073; }
    if (mixer > 13506) { mixer = mixer - 5008; counter.value += 1; } else { mixer = mixer + 10102; }
    if (mixer > 13543) { mixer = mixer - 5024; counter.value += 1; } else { mixer = mixer + 10131; }
    if (mixer > 13580) { mixer = mixer - 5040; counter.value += 1; } else { mixer = mixer + 10160; }
    if (mixer > 13617) { mixer = mixer - 5056; counter.value += 1; } else { mixer = mixer + 10189; }
    if (mixer > 13654) { mixer = mixer - 5072; counter.value += 1; } else { mixer = mixer + 10218; }
    if (mixer > 13691) { mixer = mixer - 5088; counter.value += 1; } else { mixer = mixer + 10247; }
    if (mixer > 13728) { mixer = mixer - 5104; counter.value += 1; } else { mixer = mixer + 10276; }
    if (mixer > 13765) { mixer = mixer - 5120; counter.value += 1; } else { mixer = mixer + 10305; }
    if (mixer > 13802) { mixer = mixer - 5136; counter.value += 1; } else { mixer = mixer + 10334; }
    if (mixer > 13839) { mixer = mixer - 5152; counter.value += 1; } else { mixer = mixer + 10363; }
    if (mixer > 13876) { mixer = mixer - 5168; counter.value += 1; } else { mixer = mixer + 10392; }
    if (mixer > 13913) { mixer = mixer - 5184; counter.value += 1; } else { mixer = mixer + 10421; }
    if (mixer > 13950) { mixer = mixer - 5200; counter.value += 1; } else { mixer = mixer + 10450; }
    if (mixer > 13987) { mixer = mixer - 5216; counter.value += 1; } else { mixer = mixer + 10479; }
    if (mixer > 14024) { mixer = mixer - 5232; counter.value += 1; } else { mixer = mixer + 10508; }
    if (mixer > 14061) { mixer = mixer - 5248; counter.value += 1; } else { mixer = mixer + 10537; }
    if (mixer > 14098) { mixer = mixer - 5264; counter.value += 1; } else { mixer = mixer + 10566; }
    if (mixer > 14135) { mixer = mixer - 5280; counter.value += 1; } else { mixer = mixer + 10595; }
    if (mixer > 14172) { mixer = mixer - 5296; counter.value += 1; } else { mixer = mixer + 10624; }
    if (mixer > 14209) { mixer = mixer - 5312; counter.value += 1; } else { mixer = mixer + 10653; }
    if (mixer > 14246) { mixer = mixer - 5328; counter.value += 1; } else { mixer = mixer + 10682; }
    if (mixer > 14283) { mixer = mixer - 5344; counter.value += 1; } else { mixer = mixer + 10711; }
    if (mixer > 14320) { mixer = mixer - 5360; counter.value += 1; } else { mixer = mixer + 10740; }
    if (mixer > 14357) { mixer = mixer - 5376; counter.value += 1; } else { mixer = mixer + 10769; }
    if (mixer > 14394) { mixer = mixer - 5392; counter.value += 1; } else { mixer = mixer + 10798; }
    if (mixer > 14431) { mixer = mixer - 5408; counter.value += 1; } else { mixer = mixer + 10827; }
    if (mixer > 14468) { mixer = mixer - 5424; counter.value += 1; } else { mixer = mixer + 10856; }
    if (mixer > 14505) { mixer = mixer - 5440; counter.value += 1; } else { mixer = mixer + 10885; }
    if (mixer > 14542) { mixer = mixer - 5456; counter.value += 1; } else { mixer = mixer + 10914; }
    if (mixer > 14579) { mixer = mixer - 5472; counter.value += 1; } else { mixer = mixer + 10943; }
    if (mixer > 14616) { mixer = mixer - 5488; counter.value += 1; } else { mixer = mixer + 10972; }
    if (mixer > 14653) { mixer = mixer - 5504; counter.value += 1; } else { mixer = mixer + 11001; }
    if (mixer > 14690) { mixer = mixer - 5520; counter.value += 1; } else { mixer = mixer + 11030; }
    if (mixer > 14727) { mixer = mixer - 5536; counter.value += 1; } else { mixer = mixer + 11059; }
    if (mixer > 14764) { mixer = mixer - 5552; counter.value += 1; } else { mixer = mixer + 11088; }
    if (mixer > 14801) { mixer = mixer - 5568; counter.value += 1; } else { mixer = mixer + 11117; }
    if (mixer > 14838) { mixer = mixer - 5584; counter.value += 1; } else { mixer = mixer + 11146; }
    if (mixer > 14875) { mixer = mixer - 5600; counter.value += 1; } else { mixer = mixer + 11175; }
    if (mixer > 14912) { mixer = mixer - 5616; counter.value += 1; } else { mixer = mixer + 11204; }
    if (mixer > 14949) { mixer = mixer - 5632; counter.value += 1; } else { mixer = mixer + 11233; }
    if (mixer > 14986) { mixer = mixer - 5648; counter.value += 1; } else { mixer = mixer + 11262; }
    if (mixer > 15023) { mixer = mixer - 5664; counter.value += 1; } else { mixer = mixer + 11291; }
    if (mixer > 15060) { mixer = mixer - 5680; counter.value += 1; } else { mixer = mixer + 11320; }
    if (mixer > 15097) { mixer = mixer - 5696; counter.value += 1; } else { mixer = mixer + 11349; }
    if (mixer > 15134) { mixer = mixer - 5712; counter.value += 1; } else { mixer = mixer + 11378; }
    if (mixer > 15171) { mixer = mixer - 5728; counter.value += 1; } else { mixer = mixer + 11407; }
    if (mixer > 15208) { mixer = mixer - 5744; counter.value += 1; } else { mixer = mixer + 11436; }
    if (mixer > 15245) { mixer = mixer - 5760; counter.value += 1; } else { mixer = mixer + 11465; }
    if (mixer > 15282) { mixer = mixer - 5776; counter.value += 1; } else { mixer = mixer + 11494; }
    if (mixer > 15319) { mixer = mixer - 5792; counter.value += 1; } else { mixer = mixer + 11523; }
    if (mixer > 15356) { mixer = mixer - 5808; counter.value += 1; } else { mixer = mixer + 11552; }
    if (mixer > 15393) { mixer = mixer - 5824; counter.value += 1; } else { mixer = mixer + 11581; }
    if (mixer > 15430) { mixer = mixer - 5840; counter.value += 1; } else { mixer = mixer + 11610; }
    if (mixer > 15467) { mixer = mixer - 5856; counter.value += 1; } else { mixer = mixer + 11639; }
    if (mixer > 15504) { mixer = mixer - 5872; counter.value += 1; } else { mixer = mixer + 11668; }
    if (mixer > 15541) { mixer = mixer - 5888; counter.value += 1; } else { mixer = mixer + 11697; }
    if (mixer > 15578) { mixer = mixer - 5904; counter.value += 1; } else { mixer = mixer + 11726; }
    if (mixer > 15615) { mixer = mixer - 5920; counter.value += 1; } else { mixer = mixer + 11755; }
    if (mixer > 15652) { mixer = mixer - 5936; counter.value += 1; } else { mixer = mixer + 11784; }
    if (mixer > 15689) { mixer = mixer - 5952; counter.value += 1; } else { mixer = mixer + 11813; }
    if (mixer > 15726) { mixer = mixer - 5968; counter.value += 1; } else { mixer = mixer + 11842; }
    if (mixer > 15763) { mixer = mixer - 5984; counter.value += 1; } else { mixer = mixer + 11871; }
