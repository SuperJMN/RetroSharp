...
public sealed class PackedTiledFunctionalAcceptanceTests(ITestOutputHelper output)
{
    ...
    public static TheoryData<string, string, string, string, string> ProductionSamples => new()
    {
        ...
        { "tiled-stage1-diagonal-speed-sweep", "samples/tiled-hscroll/stage1-diagonal-speed-sweep.rs", "samples/shared/platformer-assets/maps/stage1.tmx", "samples/tiled-hscroll/stage1-diagonal-speed-sweep.nes", "validation/scenarios/tiled-stage1-diagonal-speed-sweep.nes.json" },
