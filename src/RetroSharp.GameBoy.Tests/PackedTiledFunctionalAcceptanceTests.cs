...
public sealed class PackedTiledFunctionalAcceptanceTests(ITestOutputHelper output)
{
    ...
    public static TheoryData<string, string, string, string, string> ProductionSamples => new()
    {
        ...
        { "tiled-gb-fast-diagonal", "samples/tiled-gb-fast-diagonal/fast-diagonal.rs", "samples/shared/platformer-assets/maps/stage1.tmx", "samples/tiled-gb-fast-diagonal/fast-diagonal.gb", "validation/scenarios/tiled-gb-fast-diagonal.gb.json" },
        { "tiled-gb-irregular-diagonal", "samples/tiled-gb-irregular-diagonal/irregular-diagonal.rs", "samples/shared/platformer-assets/maps/stage1.tmx", "samples/tiled-gb-irregular-diagonal/irregular-diagonal.gb", "validation/scenarios/tiled-gb-irregular-diagonal.gb.json" },
        { "tiled-vertical-scroll", "samples/tiled-vertical-scroll/vertical-scroll.rs", "samples/tiled-vertical-scroll/vertical-scroll.tmj", "samples/tiled-vertical-scroll/vertical-scroll.gb", "validation/scenarios/tiled-vertical-scroll.gb.json" },
        { "tiled-gb-diagonal-streaming", "samples/tiled-gb-diagonal-streaming/diagonal-streaming.rs", "samples/tiled-gb-diagonal-streaming/diagonal-streaming.tmj", "samples/tiled-gb-diagonal-streaming/diagonal-streaming.gb", "validation/scenarios/tiled-gb-diagonal-streaming.gb.json" },
        { "tiled-cross-target-2d-scroll", "samples/tiled-cross-target-2d-scroll/cross-target-2d-scroll.rs", "samples/tiled-cross-target-2d-scroll/cross-target-2d-scroll.tmj", "samples/tiled-cross-target-2d-scroll/cross-target-2d-scroll.gb", "validation/scenarios/tiled-cross-target-2d-scroll.gb.json" },
