...
public sealed class SdkV1ReferenceTests
{
    ...
    [
        ...
        "Projectiles.Pool(name, hero: n, enemy: n, requests: n, offscreenMargin: n[, effects: pool])",
        "Projectiles.Def(name, team: Hero|Enemy, sprite: asset, speedX: n, speedY: n, damage: n, lifetime: n, hitboxWidth: n, hitboxHeight: n[, behavior: Linear|GravityArc][, tileCollision: None|Expire|Bounce][, bounceSpeedY: n][, spawnEffect: effect][, impactEffect: effect][, expireEffect: effect])",
        ...
        "Effects.Pool(name, capacity: n, requests: n)",
        "Effects.Def(name, sprite: asset, lifetime: n)",
        "effects.Request(kind, x, y)",
