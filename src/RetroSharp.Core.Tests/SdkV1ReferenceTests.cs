...
public sealed class SdkV1ReferenceTests
{
    ...
    [
        ...
        "Projectiles.Def(name, team: Hero|Enemy, sprite: asset, speedX: n, speedY: n, damage: n, lifetime: n, hitboxWidth: n, hitboxHeight: n[, behavior: Linear|GravityArc][, spawnEffect: effect][, impactEffect: effect][, expireEffect: effect])",
